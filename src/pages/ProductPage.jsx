...
export default function ProductPage() {
  ...
  /* Нормализуем галерею: если images пуст — берём primary_image */
        ...
        <div className={styles.layout}>
          ...
          <div className={`${styles.gallery} anim-scale-in`}>
            <div className={styles.mainImg}>
              ...
              />
              {outOfStock && (
                <div className={styles.outBadge}>Нет в наличии</div>
              )}
              {oldPrice && !outOfStock && (
          ...
          <div className={`${styles.info} anim-fade-up delay-1`}>
                  ...
                  {product.attributes.map(a => (
                    <div key={a.attr_key} className={styles.attrCell}>
                      <span className={styles.attrKey}>
                        {ATTR_LABELS[a.attr_key] || a.attr_key}
                      </span>
                      <span className={styles.attrVal}>
                        {a.attr_value}{a.unit ? ` ${a.unit}` : ''}
                      </span>
                    </div>
                  ))}
                </div>
            ...
            <div className={styles.accordion}>
              ...
              >
                <span>Описание</span>
                <svg
                  className={`${styles.accordionArrow} ${descOpen ? styles.accordionOpen : ''}`}
